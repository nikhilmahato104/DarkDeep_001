        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="font-display text-4xl text-stone-900 mb-8">Get In Touch</h2>
              <p className="text-stone-600 text-lg mb-12">
                Whether you want to book an appointment or simply have a query about our services, 
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-display text-xl font-bold text-stone-900 mb-1">Address</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-display text-xl font-bold text-stone-900 mb-1">Email</h3>
                    <p className="text-stone-600">info@russianspacentre.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-display text-xl font-bold text-stone-900 mb-1">Hours</h3>
                    <p className="text-stone-600">Open 24 Hours, Monday - Sunday</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <h3 className="font-display text-3xl text-stone-900 mb-6">Send a Message</h3>
              <Form {...form}>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="John Doe" {...field} className="bg-stone-50 border-stone-200" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="john@example.com" {...field} className="bg-stone-50 border-stone-200" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
